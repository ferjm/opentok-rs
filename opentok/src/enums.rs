...
impl IntoResult for ffi::otc_status {
    fn into_result(&self) -> Result<(), OtcError> {
        match *self as u32 {
            ...
            ffi::otc_error_code_OTC_UNKNOWN_PUBLISHER_INSTANCE => Err(OtcError::UnknownPublisherInstance),
            ffi::otc_error_code_OTC_UNKNOWN_SUBSCRIBER_INSTANCE => Err(OtcError::UnknownSubscriberInstance),
            ...
            ffi::otc_error_code_OT_UNABLE_TO_ACCESS_MEDIA_ENGINE => Err(OtcError::UnableToAccessMediaEngine),
